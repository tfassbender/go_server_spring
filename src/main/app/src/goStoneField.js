...
export default function GoStoneFieldComponent({row, col, setGameState, gameId, gameStateStone, nextMoveColor}) {
	 // console.log("GoStoneFieldComponent created: row=" + row + " col=" +
		// col + " gameStateStone=" + gameStateStone);
	
	return <GoStoneGamePlacementComponent row={row} col={col} setGameState={setGameState} gameId={gameId} gameStateStone={gameStateStone} nextMoveColor={nextMoveColor}>
